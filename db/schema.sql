...
CREATE TABLE media (id INTEGER PRIMARY KEY AUTOINCREMENT, word_id INTEGER NOT NULL, example_media TEXT, media_type TEXT, article_excerpt TEXT, FOREIGN KEY (word_id) REFERENCES vocabulary(id));